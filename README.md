...
저장소에 들어 있는 백업 CSV 15개(약 27MB, 고유 log_id 18,669건) 전체를 훑어서
주민번호, 카드번호, 전화번호, 이메일 패턴을 다시 찾아봤습니다.
...
├── backend/
│   ├── server-sqlite.js                       1,017줄, 엔드포인트 24개
│   └── data/secureflow.db                     26시간 구동 기록 12,458건
├── frontend/                                  React 19, chart.js / recharts
